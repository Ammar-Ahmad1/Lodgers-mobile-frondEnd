  ...
  return (
    <View style={styles.container}>
      ...
      <MapView
        ...
        initialRegion={{
          latitude: 33.6844, // latitude of Islamabad
          longitude: 73.0479, // longitude of Islamabad
          latitudeDelta: 0.0922, // adjust the desired zoom level
          longitudeDelta: 0.0421, // adjust the desired zoom level
        }}
